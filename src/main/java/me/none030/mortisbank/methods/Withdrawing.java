...
import static me.none030.mortisbank.methods.DataMethods.ChangeBankBalance;
...
public class Withdrawing {
    ...
    public static void onWithdraw(Player player, WithdrawType type) {
        ...
        if (type.equals(WithdrawType.ALL)) {
            ...
            ChangeBankBalance(player.getUniqueId(), 0);
        ...
        if (type.equals(WithdrawType.TWENTY)) {
            ...
            ChangeBankBalance(player.getUniqueId(), bank - amount);
