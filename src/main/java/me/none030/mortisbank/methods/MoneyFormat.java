...
public class MoneyFormat {
    ...
    public static String formatMoney(final double amount) {
        ...
        if (amount < 1000000.0)
            return String.valueOf(format(amount / 1000.0)) + "k";
        if (amount < 1.0E9)
            return String.valueOf(format(amount / 1000000.0)) + "M";
        if (amount < 1.0E12)
            return String.valueOf(format(amount / 1.0E9)) + "B";
        if (amount < 1.0E15)
            return String.valueOf(format(amount / 1.0E12)) + "T";
        if (amount < 1.0E18)
            return String.valueOf(format(amount / 1.0E15)) + "Q";
