...
import static me.none030.mortisbank.methods.StoringMenuItems.BankDepositItems;

public class DepositInventory implements InventoryHolder {
    ...
    private void init() {
        ...
        int slots = menus.getInt("Bank-Deposit.inv-size");
        ...
        for (MenuItem menuItem : BankDepositItems) {
