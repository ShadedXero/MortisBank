...
import static me.none030.mortisbank.methods.StoringMenuItems.PersonalBankItems;

public class PersonalBankInventory implements InventoryHolder {

    private final Inventory inv;

    public PersonalBankInventory() {
    ...
    private void init() {
        ...
        int slots = menus.getInt("Personal-Bank.inv-size");
        ...
        for (MenuItem menuItem : PersonalBankItems) {
