...
public class Manager extends CoreManager {
    ...
    public String getMessage(String id) {
        return new MessageUtils(super.getMessage(id)).setPlaceholders();
    }

    public String getMessage(String id, Player player) {
        return new MessageUtils(super.getMessage(id)).setPlaceholders(player);
    }
    ...
    public void sendMessage(String id, Player player, OfflinePlayer target) {
        player.sendMessage(new MessageUtils(super.getMessage(id)).setPlaceholders(target));
    }

    public void sendMessage(String id, Player player) {
        player.sendMessage(new MessageUtils(super.getMessage(id)).setPlaceholders(player));
    }
}
