...
import com.mortisdevelopment.mortisbank.bank.WithdrawalType;
...
public class WithdrawActionType extends MenuActionType {
    ...
    private PlaceholderEnum<WithdrawalType> placeholderType;

    public WithdrawActionType(MortisBank plugin, WithdrawalType type) throws ConfigException {
        this.plugin = plugin;
    ...
    public WithdrawActionType(MortisCore core, JavaPlugin plugin, ConfigurationSection section) throws ConfigException {
        ...
        this.placeholderType = new PlaceholderEnum<>(ConfigException.requireNonNull(section, section.getString("withdrawal-type")), WithdrawalType.class);
    }
    ...
    public void execute(Executor executor, Placeholder placeholder) {
        ...
        plugin.getBankManager().withdraw(offlinePlayer, placeholderType.getObject(placeholder));
    }
    ...
    public WithdrawActionType clone() {
        ...
        clone.plugin = plugin;
        clone.placeholderType = (PlaceholderEnum<WithdrawalType>) placeholderType.clone();
        return clone;
    }
}
